...
// â”€â”€ Player card sprite placeholder â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

// Forward v0: BREAKAWAY CROUCH — deep horizontal lean, head at left, body right
const PC_SPR_FWD_0 = [
    '....................................',
    '....................................',
    '....................................',
    '.............................####JJJ',  // top of BACK (far right, high)
    '.....................####JJJJJJJJJJJ',  // body slopes left
    '.................####JJJJJcccJJJJJJJJ',
    '..............####JJJJJJcccccJJJJJJJd',
    '..........####JJJJJJJJJJJJJJJJJJJJJD',  // wide shoulders
    '.........#jJJJJJJJJJJJJJJJJJJJJJJdG#',
    '...######.##GGJJJJcccccJJJJJJJJJdJJ#',  // HELMET TOP (cols 3-8, LEFT!) + body
    '...#HHhhhH#.#GGJJJJJJJJJJJJJJJJdJJJ#',
    '...#HhVVVhH#.#GGJJdddddddddJJJJJJJ#',
    '...#H##ss##H#.#GGJdddddddddddddJJJ##',
    '...#H##SS##H#..#KKkk#pppppppppppppp#',  // shaft starts (K at col 16)
    '....#HHsSSH##...#KKkk##ppppppppppp##',  // shaft (K at col 16)
    '...............#KKKKk#pppppppppppppp',   // shaft + pants
    '..............#KKKKKk#.#mmmmmmmm##mmmm#', // BOTH SHINS (shaft at col 12)
    '.............#KKKKKKk#.#mmmmmmmm##mmmm#',
    '............#KKKKKKk##.#mmmmmmmm##mmm##',
    '...........#KKKKKKk#...#mmmmmmmm##bbbbb#', // back BOOT starts
    '..........#KKKKKKk#....#mmmmmmmm#.#bBBBBb',
    '.........#KKKKKKk#.....#bbbbbbbb#.#aaaaaA', // front BOOT + back BLADE
    '........#KKKKKKk#......#bBBBBBBBb.#aaaaaA',
    'aaaaaaaaaaaaaaaaaaaaaa###...............',  // BLADE (left) + shaft (right)
    'aaaaaaaaaaaaaaaaaaaaa###................',
    'aaaaaaaaaaaaaaaaaaaa###..................',
    'aaaaaaaaaaaaaaaaaaa###...................',
    'aaaaaaaaaaaaaaaaaa###....................',
    '#uuu#aaaaaaaaaaaaaaA###..................',  // PUCK + blade + shaft heel
    '#uuu#aaaaaaaaaaaaaaA##...................',
    '#uuu#aaaaaaaaaaaaaA##....................',
    '.###.aaaaaaaaaaaaA##.....................',
    '......aaaaaaaaaaaaA##....................',
...
// Forward v1: WRIST SHOT — upper body rotates, stick releasing forward
const PC_SPR_FWD_1 = [
    '....................................',
    '....................................',
    '....................................',
    ...
    '.........#jJJJJJJJJJJJJJJJJJJJJJJdG#',
    '....######.##GGJJJJcccccJJJJJJJJJdJ#',
    '....#HHhhhH#.#GGJJJJJJJJJJJJJJJJdJJ#',
    '....#HhVVVhH#.#KkGGJJdddddddddJJJJJ#',
    '....#H##ss##H#.#KkGJdddddddddddddJJ##',
    '....#H##SS##H#..#KKkk#pppppppppppppp#',
    '.....#HHsSSH##...#KKkk##pppppppppppp#',
    '..............#KKKKkk#ppppppppppppppp',
    '...............#KKKKKk#mmmmmmm#.#mmmm',
    '................#KKKKKk##mmmmmm#.#mmmmm',
    '.................#KKKKk#.mmmmm#..#mmmmmm',
    '..................#KKKk#.mmmmm#...#bbbbb#',
...
// Forward v2: BACKHAND SWEEP — horizontal lean, alternate stick angle
const PC_SPR_FWD_2 = [
    '....................................',
    '....................................',
    '....................................',
    ...
    '...................####JJJJJJJJJJJJ#',
    '...............####JJJJJJcccJJJJJJJJ',
    '...........####JJJJJJJJJcccccJJJJJJd',
    '.........####JJJJJJJJJJJJJJJJJJJJJD#',
    '........#jJJJJJJJJJJJJJJJJJJJJJJdGG#',
    '...######.##GGJJJJcccccJJJJJJJJJdJJ#',
    '...#HHhhhH#.#GGJJJJJJJJJJJJJJJJdJJJ#',
    '...#HhVVVhH#.#GGJJdddddddddddJJJJJJ#',
    '...#H##ss##H#.#KkGJdddddddddddddJJ##',
    '...#H##SS##H#..#KKkk#pppppppppppppp#',
    '....#HHsSSH##...#KKkk##pppppppppppp#',
    '..............#KKKKkk#pppppppppppppp',
    '...............#KKKKKk#mmmmmmm#.#mmmmm',
    '................#KKKKKk##mmmmmm#..#mmmmm',
    '.................#KKKKk#mmmmmm#...#mmmmm#',
    '..................#KKKk#mmmmmm#...#bbbbb#',
    '...................#KKk#mmmmmm#...#bBBBBBb',
...
// Defense v0: POKE CHECK — lunging low, head at left, stick extended
const PC_SPR_DEF_0 = [
    '....................................',
    '....................................',
    '....................................',
    ...
    '..#H##ss##H#.#GGJdddddddddddddJJJ##',
    '..#H##SS##H#..#KKkk#pppppppppppppp#',
    '...#HHsSSH##...#KKkk##ppppppppppp##',
    '..............#KKKKk#pppppppppppppp',
    '.............#KKKKKk#.#mmmmmmmm##mmmm#',
    '............#KKKKKKk#.#mmmmmmmm##mmmm#',
    '...........#KKKKKKk##.#mmmmmmmm##mmm##',
    '..........#KKKKKKk#...#mmmmmmmm##bbbbb#',
    '.........#KKKKKKk#....#mmmmmmmm#.#bBBBBb',
    '........#KKKKKKk#.....#bbbbbbbb#.#aaaaaA',
    '.......#KKKKKKk#......#bBBBBBBBb.#aaaaaA',
...
// Defense v1: DEFENSIVE GAP — compact crouch, head at left, angled stick
const PC_SPR_DEF_1 = [
    '....................................',
    '....................................',
    '....................................',
    ...
    '....................####JJJJJJJJJJJ#',
    '................####JJJJJcccJJJJJJJJ',
    '............####JJJJJJJJcccccJJJJJJd',
    '.........####JJJJJJJJJJJJJJJJJJJJJD#',
    '........#jJJJJJJJJJJJJJJJJJJJJJJdGG#',
    '..######..##GGJJJJcccccJJJJJJJJJdJJ#',
    '..#HHhhhH#.#GGJJJJJJJJJJJJJJJJdJJJ#',
    '..#HhVVVhH#.#GGJJJdddddddddJJJJJJJ#',
    '..#H##ss##H#.#KkGJdddddddddddddJJJ##',
    '..#H##SS##H#..#KKkk#pppppppppppppp#',
    '...#HHsSSH##...#KKkk##ppppppppppp##',
    '..............#KKKKk#pppppppppppppp',
    '.............#KKKKKk#.#mmmmmmmm##mmmm#',
    '............#KKKKKKk#.#mmmmmmmm##mmmmm',
    '...........#KKKKKKk##.#mmmmmmmm##mmm##',
    '..........#KKKKKKk#...#mmmmmmmm##bbbbb#',
    '.........#KKKKKKk#....#mmmmmmmm#.#bBBBBb',
    '........#KKKKKKk#.....#bbbbbbbb#.#aaaaaA',
...
const PC_SPR_GTL_0 = [
    ...
    '#B..#JJJJJJJJcccccccccJJJJJJJJJd#.#',
    '#B.#JJJJJJJJcccccccccccJJJJJJJJJd##',
    '#gGGJJJJJJJJJJJJJJJJJJJJJJJJJJJdGg#',
    '#gGGGJJJJJJJJJJJJJJJJJJJJJJJJJdGGg#',
    '#gGGGGJJJJJJJJJJJJJJJJJJJJJJJdGGGg#',
    '##gGGGGGJJJJJJJJJJJJJJJJJJJJdGGGGg#',
    '.#gGGGGG##pppppppppppppppppp##GGGGg#',
    ...
    '.#ppppppp#pppppppppppppppppp#ppppp#',
    '.#ppppppp#pppppppppppppppppp#ppppp#',
    '.#ppppbbb##bbbbbbbbbbbbbbbbb##bbbp#',
...
const PC_SPR_GTL_1 = [
    ...
    '#gGGJJJJJJJJJJJJJJJJJJJJJJJJJJJdGg#',
    '#gGGJJJJJJJJJJJJJJJJJJJJJJJJJJGGGg#',
    '#gGGGgJJJJJJJJJJJJJJJJJJJJJJJGGGGg#',
    '##gGGgGGJJJJJJJJJJJJJJJJJJJJJGGGGg#',
...
function pcDrawSprite(ctx, type, pri, sec, teamCode) {
    const sc = 5;
    const cm = {
        '#': '#000000',
        'H': '#222233', 'h': '#556688',
    ...
    let hash = 0;
    if (teamCode) { for (let i = 0; i < teamCode.length; i++) hash = (hash*31 + teamCode.charCodeAt(i)) >>> 0; }
...
<div style="font-family:'Press Start 2P',cursive;background:#000;max-width:360px;margin:0 auto;user-select:none;">
  ...
  ${pcBuildHonors(pName)}
    ...
    if (spCanvas) pcDrawSprite(spCanvas.getContext('2d'), sprType, pri, sec, p.teamCode);
